...
export const cases: VascCase[] = [
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q6',
        type: 'measurement',
        prompt: 'Measurement-style question: estimate the displayed aneurysm diameter and enter the value in cm.',
        target: 'maximal aneurysm diameter',
        correctValue: 6.1,
        tolerance: 0.5,
        unit: 'cm',
        points: 3,
        hints: ['The axial viewer is real, but drawing tools are not implemented yet.', 'Use the known mock case diameter.'],
        explanation: 'The current viewer renders a real NRRD slice. The next milestone is connecting an on-canvas caliper measurement directly to this question type.',
      },
    ],
  },
  {
